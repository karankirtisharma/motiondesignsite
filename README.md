...
- Camera direction and lens changes use a 120 ms exponential response, with gentler scroll acceleration and lighter look-around controls. Camera positions stay on the checked route. A “Coming soon.” title fades over the final sculpture and recedes when scrolling back or looking around; reduced-motion preferences disable its transition.
